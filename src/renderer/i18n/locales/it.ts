export default {
  ...
  // GIF Generator
  generateGif: 'Genera GIF',
  generatingGif: 'Generazione GIF...',
  gifPreview: 'Anteprima GIF',
  downloadGif: 'Scarica GIF',
  gifGenerationError: 'Generazione GIF fallita',
  ...
  writingDays: 'Giorni di scrittura',
  avgPerDay: 'Media/Giorno',
  activeProjects: 'Progetti attivi',
  less: 'Meno',
  more: 'Di più',
  productivityByDay: 'Produttività per giorno',
  productivityByTime: 'Produttività per ora',
  monday: 'Lun',
  tuesday: 'Mar',
  wednesday: 'Mer',
  thursday: 'Gio',
